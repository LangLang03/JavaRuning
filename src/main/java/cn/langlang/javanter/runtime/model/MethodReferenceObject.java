...
import cn.langlang.javanter.ast.expression.ClassLiteralExpression;
import cn.langlang.javanter.ast.expression.Expression;
import cn.langlang.javanter.ast.expression.IdentifierExpression;
import cn.langlang.javanter.ast.expression.MethodReferenceExpression;
...
public class MethodReferenceObject implements Callable {
    ...
    private int computeConstructorScore(ScriptMethod constructor, List<Object> args) {
        List<cn.langlang.javanter.ast.declaration.ParameterDeclaration> params = constructor.getParameters();
    ...
    private void runInstanceInitializers(ExecutionContext context, ScriptClass scriptClass, RuntimeObject instance) {
        ...
        try {
            for (cn.langlang.javanter.ast.declaration.InitializerBlock init : scriptClass.getInstanceInitializers()) {
