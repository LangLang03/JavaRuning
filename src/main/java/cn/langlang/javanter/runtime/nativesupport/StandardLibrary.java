...
public class StandardLibrary {
    ...
    private Object invokeMethodReference(MethodReferenceObject methodRefObj, List<Object> args) {
        ...
        if (methodName.equals("new")) {
            if (targetExpr instanceof ClassLiteralExpression) {
                cn.langlang.javanter.ast.type.Type type = ((ClassLiteralExpression) targetExpr).getType();
    ...
    private Object createArray(cn.langlang.javanter.ast.type.Type type, int size) {
